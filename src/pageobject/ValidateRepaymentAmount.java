...
public class ValidateRepaymentAmount extends BaseClass{

	
	WebDriver driver;
	
	public ValidateRepaymentAmount(WebDriver _driver) {
		driver = _driver;
	...
	public void ValidateRepaymentAmountPageObject() throws InterruptedException, IOException {
        ...
        js.executeScript("arguments[0].click();", validateAmount);
    	Thread.sleep(15000);
